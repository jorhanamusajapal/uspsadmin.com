...
<input type="number" name="phonee" maxlength="15" required=""  placeholder="Phone Number" tabindex="8" id="taddress" class="form-control">

<br>
  <input type="email" name="eemail" maxlength="35" required=""  placeholder="Email" tabindex="8" id="eemail" class="form-control">
